...
class CouriersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create courier" do
    assert_difference("Courier.count") do
      post couriers_url, params: { courier: { person_id: @courier.person_id, settings: @courier.settings } }
    end
  ...
  test "should update courier" do
    patch courier_url(@courier), params: { courier: { person_id: @courier.person_id, settings: @courier.settings } }
