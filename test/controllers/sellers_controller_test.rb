...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference("Seller.count") do
      post sellers_url, params: { seller: { person_id: @seller.person_id, settings: @seller.settings } }
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { person_id: @seller.person_id, settings: @seller.settings } }
